...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      ...
      <ChevronDownIcon
        aria-hidden="true"
        className="relative top-px ml-1 transition duration-300 size-3 group-data-open/navigation-menu-trigger:rotate-180 group-data-popup-open/navigation-menu-trigger:rotate-180"
      />
    </NavigationMenuPrimitive.Trigger>
  );
}
